...
void listen_from_mic(void)
{
    ...
    audio_element_handle_t i2s_stream_reader, i2s_stream_writer, filter;
    ...
    ESP_LOGI(TAG, "[2.4] Link elements together [codec_chip]-->i2s_stream_reader-->filter-->i2s_stream_writer-->[speaker]");
