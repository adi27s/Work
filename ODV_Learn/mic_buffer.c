...
void app_main()
{
    ...
    audio_element_handle_t i2s_stream_reader, filter, raw_read, i2s_stream_writer, raw_write;
    ...
    i2s_stream_cfg_t i2s_cfg = I2S_STREAM_CFG_DEFAULT_WITH_PARA(I2S_NUM_0, 48000, 16, AUDIO_STREAM_READER);
    i2s_stream_reader = i2s_stream_init(&i2s_cfg);
    i2s_stream_cfg_t i2s_cfg2 = I2S_STREAM_CFG_DEFAULT_WITH_PARA(I2S_NUM_1, 16000, 16, AUDIO_STREAM_WRITER);
    ...
    audio_pipeline_register(pipeline, raw_write, "raw_write");
    ...
    const char *link_tag[5] = {"i2s", "filter", "raw","raw_write","i2s_writer"};
